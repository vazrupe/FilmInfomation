...
/**
 * @ngdoc function
 * @name filmApp.controller:AllitemlistCtrl
 * @description
 * # AllitemlistCtrl
 * Controller of the filmApp
 */
angular.module('filmApp')
  .controller('AllitemlistCtrl', ['$scope', '$location', '$http', 'TokenService', 'ModalService', 'itemType', function ($scope, $location, $http, TokenService, ModalService, itemType) {
